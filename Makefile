...
clean: 
	...
	$(RM) inc/ooo_cpu_modules.inc
	 ...
	 find prefetcher/stream_prefetcher -name \*.o -delete
	 find prefetcher/stream_prefetcher -name \*.d -delete
...
bin/champsim: $(patsubst %.cc,%.o,$(wildcard src/*.cc)) obj/repl_rreplacementDlru.a obj/pref_pprefetcherDno.a obj/pref_pprefetcherDno_instr.a obj/pref_pprefetcherDstream_prefetcher.a obj/bpred_bbranchDbimodal.a obj/btb_bbtbDbasic_btb.a
...
prefetcher/stream_prefetcher/%.o: CFLAGS += -Iprefetcher/stream_prefetcher
prefetcher/stream_prefetcher/%.o: CXXFLAGS += -Iprefetcher/stream_prefetcher
prefetcher/stream_prefetcher/%.o: CXXFLAGS +=  -Dprefetcher_initialize=pref_pprefetcherDstream_prefetcher_initialize -Dprefetcher_cache_operate=pref_pprefetcherDstream_prefetcher_cache_operate -Dprefetcher_cache_fill=pref_pprefetcherDstream_prefetcher_cache_fill -Dprefetcher_cycle_operate=pref_pprefetcherDstream_prefetcher_cycle_operate -Dprefetcher_final_stats=pref_pprefetcherDstream_prefetcher_final_stats -Dl1d_prefetcher_initialize=pref_pprefetcherDstream_prefetcher_initialize -Dl2c_prefetcher_initialize=pref_pprefetcherDstream_prefetcher_initialize -Dllc_prefetcher_initialize=pref_pprefetcherDstream_prefetcher_initialize -Dl1d_prefetcher_operate=pref_pprefetcherDstream_prefetcher_cache_operate -Dl2c_prefetcher_operate=pref_pprefetcherDstream_prefetcher_cache_operate -Dllc_prefetcher_operate=pref_pprefetcherDstream_prefetcher_cache_operate -Dl1d_prefetcher_cache_fill=pref_pprefetcherDstream_prefetcher_cache_fill -Dl2c_prefetcher_cache_fill=pref_pprefetcherDstream_prefetcher_cache_fill -Dllc_prefetcher_cache_fill=pref_pprefetcherDstream_prefetcher_cache_fill -Dl1d_prefetcher_final_stats=pref_pprefetcherDstream_prefetcher_final_stats -Dl2c_prefetcher_final_stats=pref_pprefetcherDstream_prefetcher_final_stats -Dllc_prefetcher_final_stats=pref_pprefetcherDstream_prefetcher_final_stats
obj/pref_pprefetcherDstream_prefetcher.a: $(patsubst %.cc,%.o,$(wildcard prefetcher/stream_prefetcher/*.cc)) $(patsubst %.c,%.o,$(wildcard prefetcher/stream_prefetcher/*.c))
	@mkdir -p $(dir $@)
	ar -rcs $@ $^
...
-include $(wildcard prefetcher/stream_prefetcher/*.d)
